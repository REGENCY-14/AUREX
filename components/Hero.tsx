  ...
  return (
    ...
    >
      ...
      <div className="relative flex max-w-4xl flex-col items-center gap-6 text-center">
        ...
        >
          {/* Both buttons are shorter and smaller-type on mobile (h-12/base
              text instead of the full 58px/text-lg desktop size) — full
              desktop scale kicks back in from sm. */}
          <motion.a
            {...hoverScale}
            href="/coming-soon"
            className="flex h-12 w-full items-center justify-center gap-2 bg-gradient-to-r from-gold via-gold-light via-50% to-gold px-5 font-jakarta text-base text-amainblack sm:h-[58px] sm:w-auto sm:px-6 sm:text-lg"
          >
            Become an Investor
          ...
          <motion.a
            {...hoverScale}
            href="/coming-soon"
            className="flex h-12 w-full items-center justify-center border border-gold-muted/30 bg-ink-light/50 px-6 font-sans text-sm font-medium text-neutral-200 backdrop-blur-md light:border-gold/30 light:bg-white/50 light:text-[#1a1a1a] sm:h-[58px] sm:w-auto sm:px-8 sm:text-base"
          >
            Explore AUREX
          </motion.a>
        </motion.div>
