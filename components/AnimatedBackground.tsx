...
/**
 * Shared decorative backdrop for the whole app — the AUREX "Ambient Lighting
 * Effects" from the Figma design: a soft gold glow behind the hero, a warm
 ...
 * pointer-events-none so it never affects a11y or interaction; motion is
